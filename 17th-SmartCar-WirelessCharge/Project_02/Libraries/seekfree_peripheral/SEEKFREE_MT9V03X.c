...
IFX_ALIGN(4) uint8 use_image[MT9V03X_H2][MT9V03X_W2];

IFX_ALIGN(4) uint8 Pixle[MT9V03X_H2][MT9V03X_W2];
...
int16 MT9V03X_CFG[CONFIG_FINISH][2]=
{
    ...
    {EXP_TIME,          450}, // 300?原 450   曝光时间          摄像头收到后会自动计算出最大曝光时间，如果设置过大则设置为计算出来的最大曝光值
...
void mt9v03x_init(void)
{
    ...
    uart_init (MT9V03X_COF_UART, 9600,MT9V03X_COF_UART_TX,MT9V03X_COF_UART_RX );	//初始换串口 配置摄像头MT9V03X_COF_UART_RX;
